...
<div class="form-group">
    ...
    <input type="text" name="name" class="form-control" value="{{$post->name}}" id="exampleFormControlInput1" placeholder="Your name">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="email" name="email" class="form-control" value="{{$post->email}}" id="exampleFormControlInput3" placeholder="Your email">
  </div>

  <div class="form-group">
    <label for="exampleFormControlInput4" class='font-weight-bold'>National_id</label>
    <input type="text" name="national_id" class="form-control" value="{{$post->national_id}}" id="exampleFormControlInput4" placeholder="Your national_id">
  </div>

  <div class="form-group">
    <label for="exampleFormControlInput5" class='font-weight-bold'>Avatar_img</label>
    <input type="text" name="avatar_img" class="form-control" value="{{$post->avatar_img}}" id="exampleFormControlInput5" >
  </div>
